...
#define RIGHT_MOTORS 6, -7, 9
#define GEARSET pros::E_MOTOR_GEAR_600 // RPM of chassis motors

// Ticks per inch
#define TPI 45      			  // Encoder ticks per inch of forward robot movement
#define MIDDLE_TPI 45          // Ticks per inch for the middle wheel

// Tracking wheel distances
#define TRACK_WIDTH 10.875 		  // The distance between left and right wheels (or tracker wheels)
#define MIDDLE_DISTANCE 0     // Distance from middle wheel to the robot turning center

// Sensors
#define IMU_PORT 9                           // Port 0 for disabled
